...
class CustomerRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'dni.regex' => 'El campo C.I debe ser completado con únicamente números',
            ...
            'contact_dni.regex' => 'El campo C.I de contacto debe ser completado con únicamente números',
            ...
            'telephone.regex' => 'El campo teléfono debe ser completado con números y con el signo + al inicio de ser necesario.',
            'cellphone.max' => 'El campo teléfono celular debe ser menor a :max caracteres.',
            'cellphone.regex' => 'El campo teléfono celular debe ser completado con números y con el signo + al inicio de ser necesario.',
            'contact_telephone.max' => 'El campo teléfono de contacto debe ser menor a :max caracteres.',
            'contact_telephone.regex' => 'El campo teléfono de contacto debe ser completado con números y con el signo + al inicio de ser necesario.',
    ...
    public function rules()
    {
        $rules = [
            ...
            'telephone' => 'regex:/^\+?[0-9]+$/u|max:20',
            'cellphone' => 'regex:/^\+?[0-9]+$/u|max:20',
            'contact_telephone' => 'regex:/^\+?[0-9]+$/u|max:20',
            'address' => 'required',
