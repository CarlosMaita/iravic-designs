    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Transferrencia de Stock</h5>
            ...
            <div class="modal-body">
                ...
                <div class="style-dialog-body css-g4fmj2">
                    ...
                    <div data-bn-type="text" class="css-oxzfpw">Las transferencias internas en Binance son gratuitas.</div>
                            ...
                            <div class="css-bz1qgm">
                                <div class="css-1efkrz1">
                                    <div class="css-1pxm4lx">
                                        ...
                                        <div class="css-1xcjeua">
                                            <div id="stock-destination" class="css-1pysja1">Fiat y spot</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="css-1pxm4lx">
                            <label class="css-51ezhr">
                                <div class="css-cr60ng">
                                    <div data-bn-type="text" class="css-vurnku">Stock</div>
                            ...
                            <div class=" css-17mzxiv">
                                <input data-bn-type="input" autocomplete="off" class="css-16fg16t" type="number" min="0" step="1" value="">
                                <div class="bn-input-suffix css-vurnku">
                                    <div class="css-1ii0qmr">
                                        <div data-bn-type="text" class="css-3bhv7e">MÁX.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
