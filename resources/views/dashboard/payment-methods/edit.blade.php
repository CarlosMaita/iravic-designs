                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8">
                    <div class="card">
                        <div class="card-header">
                            <i class="fa fa-credit-card"></i> Editar Método de Pago
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.payment-methods.update', $paymentMethod) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('instructions') is-invalid @enderror" 
                                              ...
                                              name="instructions" 
                                              rows="4"
                                              placeholder="Ej: Realizar pago móvil al número 0414-1234567, Banco Mercantil, V-12345678">{{ old('instructions', $paymentMethod->instructions) }}</textarea>
                                    <small class="form-text text-muted">
