                        ...
                        <div class="card-body">
                            <div class="container-fluid px-0">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    <!--  -->
                                    @include('ecommerce.my-profile._partials.personal_info')
                                    <!--  -->
                                    @include('ecommerce.my-profile._partials.account_status')
                                    <!--  -->
                                    @include('ecommerce.my-profile._partials.orders')
                                    <!--  -->
                                    @include('ecommerce.my-profile._partials.refunds')
                                    <!--  -->
                                    @include('ecommerce.my-profile._partials.payments')
                                    <!--  -->
                                    @include('ecommerce.my-profile._partials.debts')
                                    <!--  -->
                                    @include('ecommerce.my-profile._partials.visits')
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('js')
    ...
    @include('ecommerce.debts.js.index')
    @include('ecommerce.operations.js.index')
    @include('ecommerce.payments.js.index')
    @include('ecommerce.visits.js.index')
@endpush