<!-- Page footer -->
    <footer class="footer pt-5 pb-4">
      <div class="container pt-sm-2 pt-md-3 pt-lg-4">
        <div class="row pb-5 mb-lg-3 d-none">
        ...
        <div class="d-lg-flex align-items-center border-top pt-4 mt-3">
          ...
          <div class="d-md-flex justify-content-center order-lg-1">
            <ul class="nav justify-content-center gap-4 order-md-3 mb-4 mb-md-0">
              ...
              <li class="animate-underline">
                <a class="nav-link fs-xs fw-normal p-0 animate-target" href="#!">Términos de uso</a>
              </li>
            </ul>
            ...
            <p class="fs-xs text-center text-lg-start mb-0 order-md-1">
              &copy; Todos los derechos reservados. Hecho por <span class="animate-underline"><a class="animate-target text-dark-emphasis text-decoration-none" href="https://brocsoft.com" target="_blank" rel="noreferrer">Brocsoft</a></span>
            </p>
          </div>
        </div>
      </div>
